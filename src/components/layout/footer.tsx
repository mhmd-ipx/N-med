...
const Footer = () => {
  return (
    <footer className="bg-blue-600 text-white relative overflow-hidden z-20">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-[1300px] mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="lg:col-span-2 space-y-6 p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20  transition-all duration-300">
            ...
            <p className="text-white/90 leading-relaxed text-sm">
              سایت نوبت‌دهی خدمات و ویزیت دندانپزشکی؛ از معاینه و مشاوره تا جرم‌گیری، ترمیم، عصب‌کشی، ایمپلنت و ارتودنسی. پروفایل دندانپزشکان را ببینید، نظرات کاربران را بررسی کنید، هزینه‌های تقریبی را مقایسه کنید و در چند دقیقه نوبت رزرو کنید.
            </p>
          ...
          {/* Quick Links */}
          <div className="space-y-4 p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20  transition-all duration-300">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/service-categories" className="flex items-center space-x-2 space-x-reverse text-white/90 hover:text-white transition-all duration-300 hover:translate-x-1"><HiFolder className="w-4 h-4 text-white" /><span className="text-sm">دسته‌بندی‌ها</span></a></li>
          ...
          <div className="space-y-6">
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20  transition-all duration-300">
            ...
            {/* Trust Symbol */}
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20  transition-all duration-300 text-center">
